...
public class RepeatStringsTests
{
    ...
    {
        //Arrange
        string[] input = new string[] { "haha" };
        //Act
        string result = RepeatStrings.Repeat(input);
        //Assert
        Assert.That(result, Is.EqualTo("hahahahahahahaha"));
    }
    ...
    {
        //Arrange
        string[] input = new string[] { "haha", "hehe", "hoho" };
        //Act
        string result = RepeatStrings.Repeat(input);
        //Assert
        Assert.That(result, Is.EqualTo("hahahahahahahahahehehehehehehehehohohohohohohoho"));
    }
}
